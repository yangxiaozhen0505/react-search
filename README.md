...
```scss
@import 'styles/_colors.scss'; src-1
...
from [`src/index-1.js`](../201703react/src-2/index.js).

If you had previously enabled service workers in your production deployment and
have decided that you would like to disable them for all your existing users,
you can swap out the call to `serviceWorkerRegistration.register()` in
[`src/index-1.js`](../201703react/src-2/index.js) with a call to `serviceWorkerRegistration.unregister()`.
...
in all web browsers. Service worker registration [won't be attempted](../201703react/src-2/registerServiceWorker.js)
...
starting point, you can make use of the logic included in [`src/registerServiceWorker.js`](../201703react/src-2/registerServiceWorker.js), which
